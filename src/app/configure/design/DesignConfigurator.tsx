...
const DesignConfigurator = ({
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[603/640]">
          <AspectRatio
            ref={phoneCaseRef}
            ratio={603 / 640}
            className="pointer-events-none relative z-50 aspect-[603/640] w-full"
          >
            <NextImage
              fill
              alt="phone image"
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div
                    onClick={() =>
                      toast({
                        title: "Only white is available",
                        description:
                          "Sorry, this feature is currently unavailable. Please try again later.",
                      })
                    }
                  >
                    <div className="mt-3 flex disabled:opacity-50 items-center space-x-3 pointer-events-none opacity-50">
                      {COLORS.map((color) => (
                        <RadioGroup.Option
                          key={color.label}
                          value={color}
